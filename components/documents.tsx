...
export function Documents() {
  const documents = [
    ...
    // Project Proposals (Individual)
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-2/view",
      fileSize: "2.1 MB",
      downloadMethod: "direct",
      category: "document",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-3/view",
      fileSize: "2.3 MB",
      downloadMethod: "direct",
      category: "document",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-4/view",
      fileSize: "2.0 MB",
      downloadMethod: "direct",
      category: "document",
    },
    // Research Paper
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-5/view",
      fileSize: "4.5 MB",
      downloadMethod: "direct",
      category: "document",
    },
    // Final Reports
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-6/view",
      fileSize: "6.2 MB",
      downloadMethod: "direct",
      category: "document",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-7/view",
      fileSize: "5.8 MB",
      downloadMethod: "direct",
      category: "document",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-8/view",
      fileSize: "5.9 MB",
      downloadMethod: "direct",
      category: "document",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-file-id-9/view",
      fileSize: "6.0 MB",
      downloadMethod: "direct",
      category: "document",
    },
  ...
  const presentations = [
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-presentation-id-1/view",
      fileSize: "8.3 MB",
      downloadMethod: "direct",
    ...
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-presentation-id-2/view",
      fileSize: "12.1 MB",
      downloadMethod: "direct",
      category: "presentation",
    },
    {
      ...
      externalUrl: "https://drive.google.com/file/d/your-presentation-id-3/view",
      fileSize: "15.7 MB",
      downloadMethod: "direct",
      category: "presentation",
    },
