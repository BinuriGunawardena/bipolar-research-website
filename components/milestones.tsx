export function Milestones() {
  const milestones = [
    ...
    { date: "Apr 2025", name: "Final Report", marks: "19 marks", status: "current", color: "bg-blue-500" },
    { date: "May 2025", name: "Website Assessment", marks: "2 marks", status: "upcoming", color: "bg-gray-300" },
    {
      date: "May 2025",
          ...
          {milestones.map((milestone, index) => (
            ...
            >
              <div className="flex items-center gap-6">
                <div className={`w-4 h-4 rounded-full ${milestone.color} animate-pulse`}></div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-purple-600 font-bold">{milestone.marks}</span>
              </div>
            </div>
          ))}
        </div>
